...
Groups.Credits = Tabs.Miscellaneous:AddRightGroupbox('Credits')
    ...
    addRichText(Groups.Credits:AddLabel('<font color="#3da5ff">Bart3kk</font> - port to universal platform'))
    addRichText(Groups.Credits:AddLabel('<font color="#de6cff">mstudio45</font> - port of Linoria UI Lib'))
    Groups.Credits:AddLabel('ShowerHead-FluxTeam - first port, idea')
    Groups.Credits:AddLabel('Inori - PC only ui library')
