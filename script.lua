--Credits to ShowerHead-FluxTeam for the ported version of Wally-RBLX's Funky Friday AutoPlay script
--Credits to mstudio45 for the ported UI lib of Linoria
